...
describe GamesController, type: :controller do
  ...
  context 'GET #won' do
    ...
    it 'assigns moves' do
      get :won, params: { game_id: game.id }
      expect(assigns(:moves)).to be_instance_of Integer
    end

    it 'assigns lost_ships' do
      get :won, params: { game_id: game.id }
      expect(assigns(:lost_ships)).to be_instance_of Integer
    end
  ...
  context 'GET #lost' do
    ...
    it 'assigns destroyed_ships' do
      get :lost, params: { game_id: game.id }
      expect(assigns(:destroyed_ships)).to be_instance_of Integer
    end
