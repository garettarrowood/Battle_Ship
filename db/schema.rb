...
ActiveRecord::Schema.define(version: 20161027020034) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "lost_ships",             default: 0
    t.integer  "enemy_sunk_ships",       default: 0
    t.string   "last_game_result",       default: "No games completed yet"
